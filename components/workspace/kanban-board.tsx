        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="text-muted-foreground flex flex-wrap items-center gap-x-3 text-xs">
            ...
            {kind === "gercek" ? (
              ...
              >
                <Globe className="size-3" /> site <ExternalLink className="size-2.5" />
              </a>
            ) : kind === "sosyal" ? (
              <a
                href={f.website!}
              ...
              >
                sosyal medya <ExternalLink className="size-2.5" />
              </a>
            ) : (
            ...
            >
              <MapPin className="size-3" /> harita
            </a>
      ...
      <div className="flex shrink-0 items-center gap-2 pl-12 sm:pl-0">
        ...
        {wa && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex shrink-0 items-center justify-center rounded-md border border-green-300 bg-green-50 p-1.5 text-green-600 hover:bg-green-100 dark:border-green-900/60 dark:bg-green-950/40 dark:text-green-400 dark:hover:bg-green-950/70"
